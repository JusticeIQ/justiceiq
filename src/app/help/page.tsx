...
const FAQS = [
  { q: "How do referrals get into JusticeIQ?", a: "Referrals arrive automatically from JusticeChamp Consumer Intake when a consumer's claim is matched to your firm, or can be added manually in a future release." },
      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <Card className="bg-amber-50 border-amber-200">
          ...
          <p className="text-sm text-amber-900 mt-2">
            JusticeIQ is a technology platform for organizing referrals and matters. It does not perform legal analysis on
